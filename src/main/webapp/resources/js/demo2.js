$(document).ready(function () {
    ...
    var depatureDateTime = new DepartureBoard (document.getElementById ('depatureDateTime'), { rowCount: 1, letterCount: 18 });
    depatureDateTime.setValue("Departure date");
    var arrivaDatelTime = new DepartureBoard (document.getElementById ('arrivaDatelTime'), { rowCount: 1, letterCount: 16 });
